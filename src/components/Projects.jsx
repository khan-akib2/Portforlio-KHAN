...
<body>
    ...
    },
    {
      ...
      duration: '4 hours',
      teamSize: '14 Designer/Developer',
...
<body>
    <div class="flex">
        ...
        <!-- MAIN CONTENT -->
        <div class="w-full h-screen flex flex-col bg-[#F1F7F5] overflow-y-auto modal-scrollbar">
            <!-- Header -->
...
<body class="bg-gray-900 text-white">
    ...
    },
    {
      ...
      cat: 'dev',
      tech: 'Next.js/Node',
      img: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=500',
      images: ['https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=500'],
      subtitle: 'Secure password manager app',
      description: 'SafeBuddy is a full-stack password manager that lets users securely store, generate, and manage credentials. Features AES-256 encryption, master password protection, password strength analysis, and a clean dashboard for organizing vaults by category.',
      duration: '1 week',
      teamSize: '1 Developer',
      technologies: [ 'Node.js', 'Express', 'MongoDB', 'AES-256'],
      githubLink: 'https://github.com/khan-akib2/Password-Manager_Frontend',
      githubLinkBackend: 'https://github.com/khan-akib2/PasswordManager_Backend',
      liveLink: 'https://safe-buddy-com.vercel.app/',
      status: 'Completed',
      challenge: 'Implementing client-side encryption so passwords are never exposed in plaintext on the server.',
      solution: 'Used AES-256 encryption on the client before sending data, with the master password as the key — never stored server-side.',
      outcome: 'A zero-knowledge password vault where only the user can decrypt their own data.',
    },
    {
      title: 'NotiFlow',
      cat: 'dev',
      ...
      images: ['https://images.unsplash.com/photo-1577563908411-5077b6dc7624?w=500'],
      subtitle: 'Community announcement dashboard',
      description: 'NotiFlow is a real-time community announcement platform where admins can broadcast updates, events, and alerts to members. Features role-based access, rich-text announcements, read receipts, category filters, and live notification delivery via WebSockets.',
      duration: '1 week',
      teamSize: '1 Developer',
      technologies: ['Node.js', 'Express', 'MongoDB', ],
      githubLink: 'https://github.com/khan-akib2/CommunityAnnouncementBoard-NoticeFlow-.git',
      liveLink: 'https://noticeflow.vercel.app/',
      status: 'Completed',
      challenge: 'Delivering real-time announcements to all connected users instantly without polling.',
      solution: 'Integrated Socket.io for live push events, with a fallback REST API for users who connect after the broadcast.',
      outcome: 'Sub-second announcement delivery across all connected clients with persistent history for late joiners.',
    },
  ];
