...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-indigo-500/20 bg-gradient-to-b from-transparent via-slate-900/20 to-slate-950/50 px-4 sm:px-6 py-12 sm:py-16 md:py-20 overflow-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 mb-12 sm:mb-16">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-400 tracking-widest uppercase font-bold mb-4">
          ...
          <div className="text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-indigo-400 mb-6">Navigation</p>
          ...
          <div className="text-center md:text-right">
            <p className="text-xs font-bold uppercase tracking-widest text-indigo-400 mb-6">Connect</p>
        ...
        {/* Divider */}
        <div className="h-px bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent mb-8 sm:mb-10"></div>
